                    ...
                    <div class="p-6 bg-white">
                        <div class="border-2 border-black p-4 m-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-8">
                                ...
                                <!-- Contact Item 3: Book Meeting -->
                                <div class="border-2 border-[#ECBB0A] rounded-xl bg-[#223654] shadow-lg">
                                    <div class="p-4">
                                        <img src="storage/images/image 16.png" alt="Meeting Icon" class="w-12 h-12 mx-auto mb-4">
                                        <p class="text-white font-bold text-2xl text-center mb-4">Meeting with Expert</p>
                                        <button id="meetingBtn" class="bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded w-full">
                                            Book Meeting
                                        </button>
                                    </div>
                                </div>
